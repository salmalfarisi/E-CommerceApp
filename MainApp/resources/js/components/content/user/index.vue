<template>
	<div>
		<Breadcrumb v-bind:title="'Data User'" v-bind:list="['User']" />
		<div>
                  ...
                  <tbody>
                    <tr v-for="(loopdata, key) in data" :key="key" v-bind:id="'rows_'+ key">
						...
						<td v-if="loopdata.id != null" class="d-flex justify-content-center">
							<router-link :to='{name:"UserForm", params: {status: "show", id: loopdata.id}, }' class="btn btn-info btn-sm mx-1">Detail</router-link>
